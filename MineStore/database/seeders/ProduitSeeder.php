    ...
    public function run(): void
    {
        ...
        Produit::updateOrCreate(
            ...
            [
                ...
                'prix' => 14.99,
                'image' => 'images/produits/defaultdev/pop-1.png',
                'stock' => 50,
        ...
        $this->command->info('Produit "Figurine Pop Minecraft" créé/mis à jour avec succès !');

        // Créer ou mettre à jour Pop Minecraft Chat
        Produit::updateOrCreate(
            ...
            [
                ...
                'prix' => 14.99,
                'image' => 'images/produits/defaultdev/pop-2.png',
                'stock' => 50,
        ...
        $this->command->info('Produit "Pop Minecraft Chat" créé/mis à jour avec succès !');

        // Créer ou mettre à jour Pop Minecraft Femme
        Produit::updateOrCreate(
            ...
            [
                ...
                'prix' => 14.99,
                'image' => 'images/produits/defaultdev/pop-3.png',
                'stock' => 50,
        ...
        $this->command->info('Produit "Pop Minecraft Femme" créé/mis à jour avec succès !');

        // Créer ou mettre à jour Minecraft Java & Bedrock
        Produit::updateOrCreate(
            ...
            [
                ...
                'prix' => 29.99,
                'image' => 'images/produits/defaultdev/1.png',
        ...
        $this->command->info('Produit "Minecraft Java & Bedrock" créé/mis à jour avec succès !');

        // Créer ou mettre à jour Minecraft Dungeons
        Produit::updateOrCreate(
            ...
            [
                ...
                'prix' => 19.99,
                'image' => 'images/produits/defaultdev/2.png',
                'pegi' => 'images/pegi7.png',
                'stock' => 100,
                'reference' => 'MC-DG-001',
                'actif' => true,
        ...
        $this->command->info('Produit "Minecraft Dungeons" créé/mis à jour avec succès !');

        // Créer ou mettre à jour Minecraft Legends
        Produit::updateOrCreate(
            ...
            [
                ...
                'prix' => 39.99,
                'image' => 'images/produits/defaultdev/3.png',
                'pegi' => 'images/pegi7.png',
                'stock' => 100,
                'reference' => 'MC-LG-001',
                'actif' => true,
        ...
        $this->command->info('Produit "Minecraft Legends" créé/mis à jour avec succès !');

        // Créer ou mettre à jour Pop Minecraft Creeper
        Produit::updateOrCreate(
            ...
            [
                ...
                'prix' => 14.99,
                'image' => 'images/produits/defaultdev/pop-4.png',
                'stock' => 50,
        ...
        $this->command->info('Produit "Pop Minecraft Creeper" créé/mis à jour avec succès !');

        // Créer ou mettre à jour Pop Minecraft Squelette
        Produit::updateOrCreate(
            ...
            [
                ...
                'prix' => 14.99,
                'image' => 'images/produits/defaultdev/pop-5.png',
                'stock' => 50,
        ...
        $this->command->info('Produit "Pop Minecraft Squelette" créé/mis à jour avec succès !');

        // Créer ou mettre à jour Pop Chat Jaune
        Produit::updateOrCreate(
            ['nom' => 'Pop Chat Jaune'],
            [
                ...
                'prix' => 14.99,
                'image' => 'images/produits/defaultdev/pop-6.png',
                'stock' => 50,
        ...
        $this->command->info('Produit "Pop Chat Jaune" créé/mis à jour avec succès !');
    }
}
